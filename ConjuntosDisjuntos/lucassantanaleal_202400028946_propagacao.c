...
// gcc -Wall lucassantanaleal_202400028946_propagacao.c -o lucassantanaleal_202400028946_propagacao
// ./lucassantanaleal_202400028946_propagacao input.txt output.txt
...
int main(int argc, char* argv[]) {
    ...
    for (int i = 0; i < quantidade_regioes; i++) {
        ...
        fscanf(input, "%u %u %u %u", &largura, &altura, &epicentro_x, &epicentro_y);
